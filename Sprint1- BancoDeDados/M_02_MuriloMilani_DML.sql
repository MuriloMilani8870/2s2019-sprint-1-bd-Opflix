...
Insert into Usuarios(NomeUsuario,Email,Senha,CPF,Permissao)
	Values
			('Erik' , 'erik@email.com' , '123456',33280306469,'ADMINISTRADOR')
			,('Cassiana' , 'Cassiana@email.com' , '123456',85728091555,'ADMINISTRADOR') 
			,('Helena' , 'Helena@email.com' , '123456',68453044597,'COMUM')
			,('Roberto' , 'Rob@email.com' , '3110',68114610980,'COMUM')
